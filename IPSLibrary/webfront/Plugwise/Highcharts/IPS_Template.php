...
<html>
	<head>
		...
		<script type="text/javascript" src="/user/Plugwise/Highcharts/js/jquery.min.js"></script> 
		<!-- wenn lokal vorhanden .... <script type="text/javascript" src="jquery/1.7.2/jquery.js"></script> -->
		<script type="text/javascript" src="/user/Plugwise/Highcharts/js/highcharts.js"></script>
